...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonExEm(const char* label, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ButtonExx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, bool is_picked = false);
